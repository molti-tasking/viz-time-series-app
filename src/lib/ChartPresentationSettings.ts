...
export const chartPresentationSettingsSchema = z
  .union([
    z.object({
      clusterCount: z.coerce.number(),
    }),
    z.object({
      eps: z.coerce.number(),
    }),
  ...
  .and(
    z.object({
      clusterAssignmentHistoryDepth: z.coerce.number().optional(),
      mode: z.enum([
        "clusters",
        "multiline",
        "envelope",
...
export type ChartPresentationSettings = z.infer<
  typeof chartPresentationSettingsSchema
>;
